...
function CompileCompressLaTeX()
		...
		local command_call = "tmux send-keys -t \""..session..":".. window.."."..num_panes.."\" 'latexmk -auxdir=aux/ main.tex && gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.5 -dNOPAUSE -dQUIET -dBATCH -dPrinted=false -sOutputFile=compressed.pdf main.pdf'".." Enter"
        vim.cmd(":w")
		vim.fn.system(command_call)
...
vim.keymap.set("n","<leader>l", ":lua CompileCompressLaTeX()<CR>",{silent=true})
